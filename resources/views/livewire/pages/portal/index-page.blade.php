...
<g>
    ...
    <path
		...
		M226,317.9L113,158.8L0,317.9H226z M192.4,317.9L113,206.1L33.6,317.9H192.4z"/>
                ...
                <div>
                    <p class="font-bold mb-2">Мне 16 лет, могу ли я получить доступ и пройти учебную программу курса «Общественный экологический инспектор Экосистемы»?</p>
                    <p>Принять участие в учебной программе курса «Общественный экологический инспектор Экосистемы»  можно от 18 лет.</p>
                </div>
                <div>
                    <p class="font-bold mb-2">Из чего состоит программа?</p>
                    <p>ППрограмма состоит из семи модулей, в которых содержатся 35 уроков. 
                        По окончании каждого модуля вас ждут тесты и задания, которые проверят ваши знания о пройденном материале.</p>
                </div>
                <div>
                    <p class="font-bold mb-2">Тесты и задания нужны для самопроверки или же полученные за их выполнение баллы идут
                        в общий зачёт?</p>
                    <p>За тесты даются баллы, которые вносят вклад в итоговую оценку. На прохождение теста даётся 1 попытка. 
                        Задания доступны для самостоятельного прохождения с целью более эффективного закрепления теоретических знаний</p>
                </div>
                <div>
                    <p class="font-bold mb-2">Куда обращаться, если возникли вопросы?</p>
                    <p>Пишите на почту программы cu_ecosistema@mail.ru. Мы
