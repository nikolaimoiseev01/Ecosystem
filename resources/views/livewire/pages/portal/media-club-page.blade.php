<main>
    ...
    <section
        ...
        <p>Также на нашем мероприятии будет работать мобильная студия проекта Кинобус «ПРОЭКО» (Лучший экопросветительский проект по версии «Эко. Позитив» и «Ecobest»), в которой ведущий Жора Каваносян вместе с участниками Шоу разоблачит и другие экологические мифы. После завершения мероприятия автодом проекта — Кинобус — отправится в тур по Архангельской области, посвященный Форуму «ЗЕМЛЯНЕ».
        </p>
    </section>
    <section class="content mb-16">
