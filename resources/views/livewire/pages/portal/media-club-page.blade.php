<main>
    ...
    <section
        ...
        <img src="/fixed/media-welcome-svgs/welcome-media-svg-10.svg" class="absolute bottom-4 right-0 w-36"
             alt="">
        <a href="https://vk.com/video-220978501_456239183" class="border rounded-xl border-black px-16 py-1 text-2xl absolute right-16 bottom-8 hover:bg-white hover:text-black transition">Трансляция</a>
        <div
